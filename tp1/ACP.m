...
p3 = plot(X_m(1),X_m(2),'ko','linewidth',2);
p4 = plot([X_m(1) X_m(1)+ 10*U(1,1)],[X_m(2) X_m(2)+ 10*U(2,1)],'g-',[X_m(1) X_m(1)+ 10*U(1,2)],[X_m(2) X_m(2)+ 10*U(2,2)],'g--','linewidth',2);

title('Changement de repere : repere canonique VS repere principal')
legend([p1;p2;p3;p4],'nuage de points','origine','premier axe canonique','deuxieme axe canonique',...
...
p1 = plot(X_C(:,1),X_C(:,2),'r+',C(:,1),C(:,2),'b+','linewidth',2);
legend([p1],'Individus de XC projetés sur les axes de la bases canonique','Individus de XC projetés sur les axes principaux');
